<?php
	...
	if(isset($_POST['confirm']))
	{
		...
		if(!empty($_POST['shop_code']))
		{
			$sql = mysql_query("select * from billing_shop where shop_code='".$_POST['shop_code']."'");
			...
			if($num==0)
			{
				...
				mysql_query("INSERT INTO billing_shop (user_id, shop_code, name, gst_no, address, city, post_code, country)
					VALUES ($last_id,'".$_POST['shop_code']."','".$_POST['name']."','".$_POST['gst_no']."','".$_POST['address']."','".$_POST['city']."','".$_POST['post_code']."','".$_POST['country']."')");
                    ...
                    <div class="row form-group">
		                <div class="col-sm-6">
		                    <div class="form-group">
		                        ...
		                        <input type="text" id="company" name="shop_code" placeholder="Enter your shop id" class="form-control">
		                    </div>
		                </div>
		                <div class="col-sm-6">    
		                    <div class="form-group">
		                        <label for="company" class=" form-control-label">Shop Name</label>
		                        <input type="text" id="company" name="name" placeholder="Enter your shop name" class="form-control">
		                    </div>
		                </div>
		                </div>
                                        <div class="form-group">
