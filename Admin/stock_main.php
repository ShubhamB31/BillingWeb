...
<form action="stock_main.php" method="post">
<div class="row">
  <div class="col-sm-12">
    <div class="col-sm-8">
      <div class="row">
      ...
      <select name="supply_id">
        ...
        <?php
          ...
          {
            echo '<option value="'.$list['id'].'">'.$list['com_name'].'</option>';
          } 
        ?>
      </select></h4><br>
      <h4>Godown Name :
  ...
  <div class="col-sm-12" style="margin-top:20px; margin-left:20px;">
    <div class="row Sale_row" id="SaleRow0">
      <div class="col-sm-4">
        <select name="product_id[]" id="product-0" class="form-control product_id">
      ...
      <div class="col-sm-4">
        <input type="text" name="quantity[]" id="quantity-0" class="form-control quantity" onclick="calcSubTotal('0','0')" placeholder="quantity">
      </div>
      <div class="col-sm-4">
        <button><a href="javascript:void(0)" class="btn btn-succcess btn_add_more">ADD</a></button>
      </div>
    </div>
  </div>
</div>
