<?php
    ...
    {
      $id1 = $_GET['id'];
      $list1 = "select * from billing_godown where user_id = $id1";
	...
	<div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <strong><h3>Update Godown</h3></strong>
            </div>
            <br>
            <div class="card-body card-block">
                <form action="update_godown.php" method="post">
                    ...
                    <div class="row form-group">
		                <div class="col-sm-6">
		                    <div class="form-group">
		                        ...
		                        <input type="text" id="company" name="godown_code" placeholder="Enter your shop id" class="form-control" value="<?php echo $_POST['godown_code'];?>">
		                    </div>
		                </div>
		                <div class="col-sm-6">    
		                    <div class="form-group">
